...
image_folder = torchvision.datasets.ImageFolder(r'E:\DataSets\CelebA_Spoof\New_Data\face_region_random_resize',
                                                transform=torchvision.transforms.ToTensor())
data_loader = torch.utils.data.DataLoader(image_folder, batch_size=1000, shuffle=False)

imgs = np.zeros((1000, 256, 256))
...
images = []
for fn in os.listdir(r'E:\DataSets\CelebA_Spoof\New_Data\face_region_random_resize\live'):
    if fn.endswith('.jpg'):
        fd = os.path.join(r'E:\DataSets\CelebA_Spoof\New_Data\face_region_random_resize\live', fn)
